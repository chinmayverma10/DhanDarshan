...
//         const newsContainer = window.document.querySelector(".news-container");
//         const newsItem = newsContainer.querySelectorAll(".news-item")

//         newsItem.forEach((item,index)=>{
//             const newsdata = data.articles[index];
            
//             const img = item.querySelector(".news-image")
//             const title = item.querySelector(".news-title")
//             const author = item.querySelector(".news-author");
//             const source = item.querySelector(".news-source")
//             const descrip = item.querySelector(".news-description")
//             const link = item.querySelector(".news-link")
//             const publishedAt = item.querySelector(".publishedat")

//             //Changing data
//             img.src = newsdata.urlToImage;
//             title.textContent = newsdata.title;
//             source.textContent = newsdata.source.name;
//             author.textContent = newsdata.author;
//             descrip.textContent = newsdata.description
//             link.href = newsdata.url;
//             link.target = "_blank";
//             publishedAt.textContent = newsdata.publishedAt;
